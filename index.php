...
//###########################################################
	...
	if ( isset($_POST['btn-signup']) ) {
		...
		if( !$error ) {
			$guildValue = $_POST['guild'];
			$query = "INSERT INTO users(userName,userEmail,userPass, userGuild) VALUES('$username','$email','$password', '$guildValue')";
		...
		<div id = "signupForm" style = "display: none;">
			<form name = "signupForm" method="post" action="index.php#signupForm" autocomplete="off">
				...
				<select name="guild" id = "guild">
					<option value='Alpha'>Guild - Alpha</option>
					<option value='Beta'>Guild - Beta</option>
					<option value='Omega'>Guild - Omegas</option>
					<option value='Hi'>Guild - Hi</option>
				</select>
		  ...
		  <div class = "guest-sign"><a href = "home.html">Enter as guest</a></div>
		</div>
